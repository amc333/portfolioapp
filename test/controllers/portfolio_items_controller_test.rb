...
class PortfolioItemsControllerTest < ActionController::TestCase
  ...
  test "should create portfolio_item" do
    assert_difference('PortfolioItem.count') do
      post :create, portfolio_item: { active: @portfolio_item.active, caption: @portfolio_item.caption, description: @portfolio_item.description, image: @portfolio_item.image, order: @portfolio_item.order }
    end
  ...
  test "should update portfolio_item" do
    patch :update, id: @portfolio_item, portfolio_item: { active: @portfolio_item.active, caption: @portfolio_item.caption, description: @portfolio_item.description, image: @portfolio_item.image, order: @portfolio_item.order }
    assert_redirected_to portfolio_item_path(assigns(:portfolio_item))
  end
